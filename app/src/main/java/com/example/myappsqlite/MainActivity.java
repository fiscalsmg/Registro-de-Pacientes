...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void registrar() {
        ConexionBD admin = new ConexionBD(this, "tortugaBD", null, 1);
        SQLiteDatabase BaseDeDatos = admin.getWritableDatabase();//abre bd modo leectura y escritura
        ...
        if (!id.isEmpty() && !raza.isEmpty() && !color.isEmpty()) {
            ...
            //guarda los valores que el usuario ha escrito
            registro.put("id", id);
            registro.put("raza", raza);
            registro.put("color", color);

            BaseDeDatos.insert("tortuga", null, registro);
            BaseDeDatos.close();
            edt_id.setText("");
            edt_raza.setText("");
            edt_color.setText("");
